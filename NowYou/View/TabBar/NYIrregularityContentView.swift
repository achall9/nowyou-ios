...
class NYIrregularityBasicContentView: NYBouncesContentView {
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        
        textColor = UIColor.gray
        highlightTextColor = UIColor.init(hexValue: 0x60DF76)
        iconColor = UIColor.gray
        highlightIconColor = UIColor.init(hexValue: 0x60DF76)
...
class NYIrregularityContentView: ESTabBarItemContentView {

    override init(frame: CGRect) {
        super.init(frame: frame)
        
        self.imageView.backgroundColor = UIColor.init(hexValue: 0x60DF76)
    ...
    public override func selectAnimation(animated: Bool, completion: (() -> ())?) {
        ...
        view.backgroundColor = UIColor(hexValue: 0x979797)
