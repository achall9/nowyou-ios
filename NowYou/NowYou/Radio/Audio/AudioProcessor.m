...
//        [[[[_rootRef child:@"Radio"] child:[NSString stringWithFormat:@"%ld", (long)self.radioId]] child:@"data"] setValue:stringForm];
        
        [[[[_rootRef child:@"Radio"] child:[NSString stringWithFormat:@"%ld", (long)self.radioId]] child:@"data"] setValue:@{@"data": stringForm, @"date": time}];
    }
}
