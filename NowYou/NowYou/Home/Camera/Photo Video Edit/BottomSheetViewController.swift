...
//            forCellWithReuseIdentifier: "StickerCollectionViewCell")
        ...
        emojisCollectioView.register(UINib(nibName: "EmojiCollectionHeaderView", bundle: Bundle.main), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "EmojiCollectionHeaderView")
...
//                                     height: view.frame.height - 40)
        ...
        emojisCollectioView.frame = CGRect(x: 0, //scrollView.frame.size.width,
                                           y: 0,
                                           width: UIScreen.main.bounds.width,
                                           height: view.frame.height - 40)
